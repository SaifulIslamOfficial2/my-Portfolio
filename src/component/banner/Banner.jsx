...
const [text] = useTypewriter({
  ...
  return (
    <div className="flex items-center mt-12 pb-24 border-b-black">
      <div className="w-1/2">
        <div>
        ...
        <div className="flex justify-between">
          <div>
            ...
            <div className="flex gap-3">
              <Link to={"https://www.facebook.com/mdsaifulislambd2"} className="p-3 transition-transform  hover:scale-110 decoration-300  rounded bg-bodyColor shadow-shadowOne">
                {" "}
                <FaFacebookF className="text-green-400" />
              </Link>
              <Link className="p-3 transition-transform  hover:scale-110 decoration-300  rounded bg-bodyColor shadow-shadowOne">
                <FaInstagram className="text-green-400" />
              </Link>
              <Link to={"https://www.linkedin.com/in/saifulislamofficial2/"} className="p-3 transition-transform  hover:scale-110 decoration-300  rounded bg-bodyColor shadow-shadowOne">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <Link className="p-2 transition-transform  hover:scale-110 decoration-300  rounded bg-bodyColor shadow-shadowOne">
               <img src={figma} alt="" />
              </Link>
              <Link to={"https://github.com/SaifulIslamOfficial2"} className="p-3 transition-transform  hover:scale-110 decoration-300  rounded bg-bodyColor shadow-shadowOne">
